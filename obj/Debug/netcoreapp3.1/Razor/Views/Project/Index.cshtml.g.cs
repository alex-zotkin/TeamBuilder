#pragma checksum "C:\Users\PC Master\Desktop\Проект КОНСТРУКТОР КОМАНД\TeamBuilder\Views\Project\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d3c514f9bdf991a8e86a4c1c02d7ec37def3d46c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d3c514f9bdf991a8e86a4c1c02d7ec37def3d46c", @"/Views/Project/Index.cshtml")]
    ...
    public class Views_Project_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d3c514f9bdf991a8e86a4c1c02d7ec37def3d46c4159", async() => {
            }
            );
...
<div id=""app"" v-cloak>
    ...
    <div class=""project_actions_box"" :style=""'width: calc(100% - ' + project_width  + 'px );'"">
        ...
        <div class=""admin_actions"" v-if=""data.IsUserAdmin"">
            ...
            <div class=""but");
            WriteLiteral(@"ton button_green"" v-if=""!editMode"" v-on:click=""StartEdit"">Редактировать</div>
        ...
        <div class=""news"" v-if=""!news_pos_change"">
            <ul>
                <li v-for=""news in data.News"">
                    ...
                    <p sty");
            WriteLiteral(@"le=""margin-bottom: 10px;"">{{news.Text}}</p>
                    <br>
    ...
    <div class=""user_list_box"" :style=""'right:' + admins_pos + 'px'"">
        ...
        <ul v-if=""!admins_pos_change"">
            <li v-on:mousemove=""ShowInfo($event, admin)"" v-for=""admin in data.ProjectAdmins""
                v-on");
            WriteLiteral(@":mouseleave=""infoBool = false"">
    ...
    <div class=""project_list"" :style=""'width: calc(100% - ' + project_width  + 'px );'"">
        ...
        <div class=""team team_active"" v-for=""team in data.Teams"">
            ...
            EndWriteAttribute();
            WriteLiteral(@" class=""button button_grey"">Подробнее</a>
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d3c514f9bdf991a8e86a4c1c02d7ec37def3d46c13475", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
