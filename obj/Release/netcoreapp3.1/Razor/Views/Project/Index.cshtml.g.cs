#pragma checksum "C:\Users\PC Master\Desktop\Проект КОНСТРУКТОР КОМАНД\TeamBuilder\Views\Project\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d9153d6688f213b1141ee3b45ed7084d0199ca4c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d9153d6688f213b1141ee3b45ed7084d0199ca4c", @"/Views/Project/Index.cshtml")]
    ...
    public class Views_Project_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d9153d6688f213b1141ee3b45ed7084d0199ca4c4194", async() => {
            }
            );
...
<div id=""app"" v-cloak>
        ...
        <div class=""news"" v-if=""!news_pos_change"">
            <ul>
                <li v-for=""news in data.News"">
                   ");
            WriteLiteral(@" <span class=""delete_news"" v-on:click=""deleteNew(news.NewId)"" v-if=""data.IsUserAdmin"">❌</span>
    ...
    <div class=""user_list_box"" :style=""'right:' + admins_pos + 'px'"">
        ...
        <h5 style=""margin-left: -25px; margin-bottom: 20px;"">
            ...
            WriteLiteral(@": 10px"" class=""span_arrow"" v-on:click=""box_resize('admin')"" v-if=""!admins_pos_change"">▶</span>
        ...
        <ul v-if=""!admins_pos_change"" style=""margin-bottom: 50px;"">
            <li v-on:mousemove=""ShowInfo($event, ju");
            WriteLiteral(@"ry)"" v-for=""jury in data.ProjectJury""
                v-on:mouseleave=""infoBool = false"">
    ...
    <div class=""project_list"" :style=""'width: calc(100% - ' + project_width  + 'px );'"">
        ...
        <div class=""team team_active"" v-for=""team in data.Teams"" :style=""{borderColor: (data.IsUserInTeam == team.TeamId) ? 'rgba(0,0,255,0.4)' : 'lightgray', background: (data.IsUserInTeam == team.TeamId) ? 'rgba(0,0,255,0.04)' : 'white'}"">
            ...
            WriteLiteral(@"m_description"">
             ...
             ");
            WriteLiteral(@"       <div class=""team_users"">
                ...
                <div class=""team_buttons"">
                    ...
                    <button class=""button button_red"" v-else-if=""(typeof applications[team.TeamId] != 'undefined') && applications");
            WriteLiteral(@"[team.TeamId].Checked && !applications[team.TeamId].Successed"" v-on:click=""deleteApplication(team.TeamId, data.CurrentUser.UserId)"">Ваша заявка отклонена</button>
        ...
        <!--<div class=""team team_disabled"" v-if=""editMode"">
            ...
            <div class=""editSizeInput"">
                ...
                <div class=""label"">
     ");
            WriteLiteral(@"               <label>2 курс</label>
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d9153d6688f213b1141ee3b45ed7084d0199ca4c16458", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
